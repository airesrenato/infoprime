            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                        <form method="post" action="../../metodos/defineLider.php" enctype="multipart/form-data" >
                            <div class="row clearfix">
                                <div class="col-md-12">
                                    <p>
                                        <b>Escolha um lider para a OS</b>
                                    </p>
                                    <select class="form-control show-tick" name="idLider" required>
                                        <?php 
                                           ...
                                           // select * from usuario u inner join usuario_has_ordemservico uos on u.idUsuario = uos.idUsuario where uos.idordemServico = 9  ;
                                           $query = "SELECT * FROM usuario u INNER JOIN usuario_has_ordemservico uos on u.idUsuario = uos.idUsuario WHERE uos.idordemServico = ".$_GET['idordemServico']." ";
                                    ...
                                    <input type = 'hidden' name = 'idordemServico' value='<?php echo $_GET['idordemServico'] ?>'>
                                </div>
                            </div>
